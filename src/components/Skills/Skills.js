      ...
      <div className="Skills">
        <div className="skill-container">
          ...
          <ul className="skill-icon-container">
              ...
              <li><span className='skill-icon-span'><img src={gitIcon} alt="github icon" className='skills-icon skills-github-icon'/></span></li>                
              ...
              <li><span className='skill-icon-span'><img src={jestIcon} alt="jest icon" className='skills-icon skills-jest-icon'/></span></li>
